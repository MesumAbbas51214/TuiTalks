...
2. Push to `main` or `work` (or run the workflow manually). The `Deploy to Netlify` workflow will install dependencies, build the project, and publish `dist` with `netlify deploy --prod`.
